...
public class RunMultiPrintNumThread {				// 例程
	public static void main(String[] args) {		// main()方法
		...
		PrintNumberThread threadOne = new PrintNumberThread(7);
		PrintNumberThread threadTwo = new PrintNumberThread(10);
		PrintNumberThread threadTre = new PrintNumberThread(5);
		// 给两个PrintNumberThread的实例设置不同的名字
		threadOne.setName("线程1");
		threadTwo.setName("线程2");
		threadTre.setName("线程3");
		// 分别启动两个线程
		threadOne.start();
		threadTwo.start();
		threadTre.start();
